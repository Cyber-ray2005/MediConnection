...
export default function PaymentSection(props) {
    ...
    async function appendPayments() {
        try {
            const url = `http://localhost:4090/api/appointments/${props.appointment.id}/payments`;
    ...
    async function deletePayment(id) {
        try {
            const response = await axios.delete(`http://localhost:4090/api/appointments/${props.appointment.id}/payments/${id}`, {
